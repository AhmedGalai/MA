        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                helpSection(title: "Windows") {
                    Text("Open ROI Window to align the ROI ring over the UXPlay feed.")
                    Text("Open Debug Viewer for feeds, matrices, and controls.")
                }

                helpSection(title: "ROI") {
                    Text("Use the ROI window sliders to set center X, center Y, and radius.")
                    Text("The ROI values are normalized (0–1) and sent to /avp_roi_config.")
                }
